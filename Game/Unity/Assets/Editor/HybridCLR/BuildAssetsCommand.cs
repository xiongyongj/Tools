...
namespace HybridCLR.Editor
{
    public static class BuildAssetsCommand
    {
        ...
        [MenuItem("Build/Build Code And Copy")]
        ...
        public static void CopyABAOTHotUpdateDlls(BuildTarget target)
        {
            ...
            CopyAOTAssembliesToScipts();
            CopyHotUpdateAssembliesToScipts();
        }
        ...
        public static void CopyAOTAssembliesToScipts()
        {
            var target = EditorUserBuildSettings.activeBuildTarget;
            string aotAssembliesSrcDir = SettingsUtil.GetAssembliesPostIl2CppStripDir(target);
            string aotAssembliesDstDir = Path.Combine(Application.dataPath, "Bundles/Scripts");
        ...
        public static void CopyHotUpdateAssembliesToScipts()
        {
            var target = EditorUserBuildSettings.activeBuildTarget;

            string hotfixDllSrcDir = SettingsUtil.GetHotUpdateDllsOutputDirByTarget(target);
            string hotfixAssembliesDstDir = Path.Combine(Application.dataPath, "Bundles/Scripts");
