...
namespace YooAsset.Editor
{
    ...
    {
        // EBuildPackageName
        public static string GetCurrentBuildPackageName()
        {
            string key = $"{Application.productName}_Current_PackageName";
            return EditorPrefs.GetString(key);
        }
        public static void SetCurrentBuildPackageName(string packageName)
        {
            string key = $"{Application.productName}_Current_PackageName";
            EditorPrefs.SetString(key, packageName);
        }
